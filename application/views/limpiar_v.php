...
<body>
		<div class="row">
			<div class="twelve columns">
				...
				<label>Limpiar horarios del trimestre: &nbsp; <b style="font-size:20px;"><?= $trim ?></b></label>
					...
					<form class="custom" action="" method="post">
						<div class="row">
						    ...
						    <div class="three columns">
						      	<label for="checkbox220b"><input type="checkbox" id="checkbox220" name="checkboxes2[]" style='display: none;' value="221"><span class="custom checkbox"></span> 220-B</label>
							</div>
							<div class="one columns"></div>
						</div><hr>
						...
						<input type="submit" id="vaciarBtn" class="button four columns" value="Limpiar" />
						<div class="four columns"></div>
					</form>
				</fieldset>
