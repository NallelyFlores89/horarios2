...
<head>
	...
	<style>
		...
		.div-9, ul.listaotro{color:#F78181;} .div-esp{background:#4DB788;} .lista1{width:100%; height:auto; background:red; margin-top:-300px;}
		...
		<h5>Especiales</h5>
			<table  border='1'>
				...
				if($filtro != NULL){
					...
					<table border="1">
						<tr><th colspan="6" class="labo"><?= $i ?></th></tr>
						<tr><th class="th2 col-uea">UEA</th><th class="th2 col-grupo">Grupo</th><th class="th2 col-sig">Siglas</th><th class="th2 col-hora">Hora</th>
						<th class="th2 col-dia">Día</th><th class="th2 col-sem">Semanas</th></tr>
						<?php 
