...
function ventanaCambiaLabo(idgrupo,lab, idtrim){
	liga=base+'index.php/administracion_c/cambia_labo/'+idgrupo+'/'+lab+'/'+idtrim
...
function ventanaCambiaHora(idgrupo, siglas, idlab, idtrim){
	liga=base+'index.php/administracion_c/cambiaHora/'+idgrupo+'/'+siglas+'/'+idlab+'/'+idtrim
	window.open(liga, 'Cambia hora', 'status=1,width=900,height=400, resizable=0, scrollbars=1') 
	return 0;
}
//Funciones para grupos_v
...
function ventanaEliminaUea(claveuea){
	liga=base+'index.php/ueas_c/elimina_uea/'+claveuea
